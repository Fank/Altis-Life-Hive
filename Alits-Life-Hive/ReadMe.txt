========================================================================
    DYNAMIC LINK LIBRARY: Alits-Life-Hive-Projektübersicht
========================================================================

Diese Alits-Life-Hive-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Alits-Life-Hive-Anwendung besteht.


Alits-Life-Hive.vcxproj
...
Alits-Life-Hive.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Alits-Life-Hive.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
